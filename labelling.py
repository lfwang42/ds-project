...
with open('newdata.json', encoding='utf-8') as f:
    textmap = json.load(f)
f.close()
client = OpenAI(api_key='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')
